...
const { getProduct, showProduct, singleProduct, searchProduct, trendingProduct } = require('../controller/product');
...
router.get("/product",userLogin, trendingProduct)
router.get("/all-product",userLogin, showProduct)
